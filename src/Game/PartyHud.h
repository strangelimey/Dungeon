...
// implementations live one file pair per widget — see CharacterPanel,
// HandSlot, SpellbookPanel, InventoryWindow, CharacterSheet, plus
// PartyHudTypes / PartyHudDraw for the shared pieces.
// ============================================================================
#pragma once
